...
题目信息：朋友的网站被黑客上传了webshell后门，他把网站打包备份了，你能帮忙找到黑客的webshell在哪吗？(Webshell中的密码(md5)即为答案)。 注意：得到的 flag 请包上 flag{} 提交
...
![](assets/作业/file-20260603192144740.png)
关键在 `phpinfo();` ，对应的响应包解码得到HTML文件

![](assets/作业/file-20260603192342825.png)

搜索得到服务器IP地址 172.17.0.2
攻击者一直在使用php代码通过WEB进程操作，所以用户为www-data

![](assets/作业/file-20260603192510800.png)
